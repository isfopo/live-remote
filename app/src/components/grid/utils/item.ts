...
export function coordinate2position(
  coordinate: number,
  cellSize: number,
  gap: number
): number {
...
export function coordinate2size(
  coordinate: number,
  cellSize: number,
  gap: number
): number {
...
export function position2coordinate(
  position: number,
  cellSize: number,
  gap: number
): number {
...
export function size2coordinate(
  size: number,
  cellSize: number,
  gap: number
): number {
...
export type SnapGridParams = Required<
  Pick<GridParams, "itemSize" | "gap" | "maxCols" | "maxRows">
>;
